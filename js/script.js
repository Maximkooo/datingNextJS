...
function openNav() {
  ...
  document.getElementById("mySidenavFon").style.display = "block";
}

function closeNav(){ 
  document.querySelector('.sidefon').addEventListener('click', function (){ 
    document.getElementById("mySidenav").style.width = "0";
    document.getElementById("mySidenavFon").style.display = "none";
  })
}

// Header menu underscore

if(document.location.href.includes('search')){
  let items = document.querySelectorAll('li.rd-nav-item')
